...
public class Restaurant {
	...
	// in the future, we will be creating a MODEL for RestaurantPayments for any custom fields
	// RESTAURANTS will have MANY PAYMENTS
	// EACH PAYMENT will have MANY RESTAURANTS
	@ManyToMany()
	...
	// menus => restaurants :: customers => agents
	// A restaurant will have MANY menus
	// An agent will have MANY customers
	 ...
	 * @param payments     The payments associated with this restaurant
	 * @param menus        The menus associated with this restaurant
	 */
	public Restaurant(
			String name,
			String address,
